...
const Pricing = () => {
    return (
        <div>
            ...
            <div className="grid grid-cols-3 ml-20 pt-20">

            
          <div className="card-1 w-96 bg-base-100 shadow-sm">
  <div className="card-body">
    ...
    <div className="mt-6">
      <button className="btn btn-primary btn-block rounded-full">Get Started Free</button>
          ...
          <div className="card-2 w-96 bg-[#4F39F6] shadow-sm">
  <div className="card-body text-white">
    ...
    <div className="mt-6">
      <button className="btn bg-white text-[#4F39F6] btn-block rounded-full">Start Pro Trial</button>
          ...
          <div className="card-3 w-96 bg-base-100 shadow-sm">
  <div className="card-body">
    <span className="badge badge-xs badge-warning">Most Popular</span>
    <div className="">
